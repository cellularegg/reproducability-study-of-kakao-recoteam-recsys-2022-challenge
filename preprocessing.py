...
def train_test_split(submit=False):
    ...
    print(len(last_month_session_ids))
    shuffled_ids = shuffle(last_month_session_ids)

    # paper stated half of last month was used as validation, other half was used as test
    # but len(last_month_session_ids)=~80000
    val_session_ids = shuffled_ids[:1000]
    te_session_ids = shuffled_ids[1001:]
